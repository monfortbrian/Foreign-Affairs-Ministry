    ...
    return (
        <div className="text-gray-600 text-sm">
            ...
            <div className="max-w-6xl mx-auto px-4 py-10">
                <h1 className="text-2xl font-bold mb-10">News</h1>
                <div className="md:grid md:grid-cols-3 gap-3">
                    <div className="rounded-md overflow-hidden">
                        <Image src="/man.jpg" width={420} height={300} alt="abc" className="object-cover m-0 p-0"/>
                        <div className="p-4">
                    ...
                    <div className="rounded-md overflow-hidden">
                        <Image src="/woman.jpg" width={420} height={300} alt="abc" className="object-cover m-0 p-0"/>
                        <div className="p-4">
                    ...
                    <div className="rounded-md overflow-hidden">
                        <Image src="/drummers.jpg" width={420} height={300} alt="abc" className="object-cover m-0 p-0"/>
                        <div className="p-4">
                    ...
                    <div className="rounded-md overflow-hidden">
                        <Image src="/burundi2.jpg" width={420} height={300} alt="abc" className="object-cover m-0 p-0"/>
                        <div className="p-4">
                            <h2 className="font-semibold mb-4 text-base">Tellus integer feugiat scelerisque varius morbi enim. </h2>
                            <p className="text-gray-400 mb-4">Phasellus vestibulum lorem sed risus ultricies. Egestas egestas fringilla phasellus faucibus scelerisque eleifend donec. Quis viverra nibh cras pulvinar mattis. </p>
                            <Link href="/"><a className="text-green-400">Read more</a></Link>
            ...
            <Link href="/"><a className="text-center block mb-20 text-green-400">View more</a></Link>
            <BtnScrollTop/>
            <Footer/>
        </div>
    )
