...
const Comeca = () => {
    return (
        <div className="text-gray-600">
            <Header sticky={true}/>
            <ForeignAffairsMenu/>
            <div className="bg-cover bg-bottom bg-fixed" style={{backgroundImage:"url('/burundi2.jpg')"}}>
                <div className="mx-auto max-w-6xl text-white pt-16 px-4">
                <h1 className="text-xl py-6 font-bold">Common Market for Eastern and Southern Africa</h1>
